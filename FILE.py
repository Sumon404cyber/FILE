...
princp=[]
try:
	prox= requests.get('https://github.com/Sumon404cyber/FILE/blob/main/APPROVAL.TXT').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Sumon404cyber/FILE/blob/main/APPROVAL.TXT').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Sumon404cyber/FILE/blob/main/APPROVAL.TXT").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
